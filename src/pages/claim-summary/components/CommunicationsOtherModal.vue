                ...
                <q-item-section>
                    ...
                    <template>
                        <q-item
                            ...
                            class="item-filter"
                        >
                            <q-item-section @click="otherDialog = true">
      ...
      <q-card style="width: 900px; max-width: 80vw;">
        <q-card-section>
          ...
          <div class="row justify-center dialog__header">
            <div class="col-sm-5 col-md-5 col-lg-5 dialog__title">Other Details</div>
            <div class="col-sm-4 col-md-3 col-lg-3 q-mr-sm">
              <q-btn rounded unelevated label="Back To Summary" class="q-mt-sm dialog__btn" v-close-popup />
            </div>
            <div class="col-sm-2 col-md-3 col-lg-3">
              <q-btn rounded unelevated label="Save" class="q-mt-sm dialog__btn" />
            </div>
          </div>
        </q-card-section>
