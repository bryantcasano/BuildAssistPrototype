                        ...
                        <q-list class="q-mb-md">
                            ...
                            >
                                <div class="row justify-center bg-white q-col-gutter-x-md q-pl-lg q-pr-lg q-pt-md q-pb-md">
                                    ...
                                    <div class="col-sm-6 col-md-6 q-mt-lg text-regular">
                                        Claim Received* <br/>
                                        <q-input square outlined v-model="claimReceived" dense mask="date" :rules="['date'] && [ val => !!val || 'Required' ]" readonly>
                                            <template v-slot:append>
                                                <q-icon name="event" class="cursor-pointer">
                                                    <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
                                                        <q-date v-model="claimReceived" @input="() => $refs.qDateProxy.hide()" readonly />
                                                    </q-popup-proxy>
                                                </q-icon>
                                            </template>
                                        </q-input>
                                    ...
                                    <div class="col-sm-6 col-md-6 q-mt-lg text-regular">
                                        Date of Loss  <br/>
                                        <q-input square outlined v-model="dateOfLoss" dense mask="date" :rules="['date']">
                                            <template v-slot:append>
                                                <q-icon name="event" class="cursor-pointer">
                                                    <q-popup-proxy ref="qDateProxy" transition-show="scale" transition-hide="scale">
...
export default {
    ...
    data: () => ({
        ...
        // -- claim details
        selectedProductLine: 'Household',
        selectedInsurer: 'Insurer',
        selectedInsurerStateOffice: 'Option 1',
        selectedInsurerDepartment: 'Lorem Ipsum',
        selectedInsurerClaimsHandler: 'test Claims Handler',
        selectedBrokerOffice: 'Option 1',
        selectedBroker: 'Option 1',
        selectedSendReportTo: 'Option 1',
        selectedEventCode: 'Day to Day',
        selectedEventType: 'Gradual Damage',
        selectedNotificationMethod: 'Option 1',
        selectedInsurerInstruction: 'For Testing Purposes',
        selectedAssessmentType: 'Option 1',
        selectedIndemnityStatus: 'Awaiting Approval',
        selectedClaimClassification: 'Not Classified',
        // -- policy holder
        selectedClaimantType: 'Option 1',
        selectedSalutation: 'Ms.',
        selectedpSalutation: '',
        selectedsSalutation: 'Mr.',
        selectedPreferredContact: 'Option 1',
        selectedpPreferredContact: '',
        selectedsPreferredContact: 'Option 1',
        selectedTaxStatus: 'Option 1',
        // -- addresses
        selectedSiteState: 'NI',
        selectedIncidentState: '',
        selectedPostalState: '',
        selectedRegion: '',
        // -- policy details
        selectedBuildingPolicyType: 'Option 1',
        selectedContentsPolicyType: 'Option 1',
        selectedContentsLimit: 'Option 1',
        selectedProductType: 'Option 1',
        // -- other information
        selectedPropertyOccupancy: 'Option 1',
        selectedClaimFormStatus: 'Option 1',
        selectedAssignTo: 'Cherry Blossom',
        // start of datepicker v-model
        // -- claim details
        claimReceived: '2020/08/23',
        dateOfLoss: '2020/01/01',
        // -- policy details
        buildingPolicyInception: '2020/08/23',
        buildingPolicyExpiry: '2020/09/30',
        contentsPolicyInception: '2020/08/23',
        contentsPolicyExpiry: '2020/09/30',
        // start of input v-model
        // -- claim details
        insurerReferenceNoInput: 'REG100001',
        claimantReferenceNoInput: 'REG001',
        otherReferenceNoInput: 'Lorem Ipsum',
        claimDescriptionInput: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc cursus quam nec nisi pellentesque interdum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc cursus quam nec nisi pellentesque interdum.',
        insurerNotesInput: 'Backup Contact',
        // -- policy holder
        firstNameInput: 'Cherry',
        lastNameInput: 'Blossom',
        workPhoneInput: '123456',
        homePhoneInput: '123456',
        mobilePhoneInput: '123456',
        emailInput: 'cherry.blossom@test.com.au',
        pfirstNameInput: '',
        plastNameInput: '',
        pworkPhoneInput: '',
        phomePhoneInput: '',
        pmobilePhoneInput: '',
        pemailInput: '',
        sfirstNameInput: 'Cliff',
        slastNameInput: 'Hangar',
        sworkPhoneInput: '123456',
        shomePhoneInput: '123456',
        smobilePhoneInput: '123456',
        semailInput: 'cliff.hangar@test.com.au',
        businessNameInput: 'Lorem Ipsum',
        businessPhoneInput: '123456',
        businessEmailInput: 'test@test.com.au',
        taxRegistrationNoInput: '123456',
        contactInstructionsInput: 'Lorem Ipsum',
        relationshipToClaimantInput: 'Officemate',
        // -- addresses
        siteStreetAddressInput: '41 Rosendale Avenue',
        siteSuburbInput: 'Spotswood',
        sitePostCodeInput: '4310',
        siteDirectionsInput: '',
        ...
        postalPostCodeInput: '',
        // -- policy details
        buildingPolicyNumberInput: '123456',
        buildingSumInsuredInput: 'Lorem Ipsum',
        buildingAreaInsuredInput: 'Lorem Ipsum',
        buildingExcessInput: 'Lorem Ipsum',
        buildingRExcessInput: 'Lorem Ipsum',
        buildingLimitInput: 'Lorem Ipsum',
        contentsPolicyNumberInput: '123456',
        contentsSumInsuredInput: 'Lorem Ipsum',
        contentsExcessInput: 'Lorem Ipsum',
        contentsRExcessInput: 'Lorem Ipsum',
        contentsLimitValueInput: 'Lorem Ipsum',
        contentsLimitInput: 'Lorem Ipsum',
        // -- other information
        otherEmailInput: '',
